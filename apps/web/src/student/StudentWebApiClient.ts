...
const SESSION_KEY = 'ieumlog:web-student-session';
...
export class StudentWebApiClient {
  ...
  async uploadEvidence(
    ...
    try {
      ...
      if (reservedEvidenceId) {
        await this.edge('discard-evidence-upload', { evidenceId: reservedEvidenceId }).catch(() => undefined);
      }
      throw error;
    }
  }
